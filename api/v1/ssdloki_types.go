...
// SsdLokiSpec defines the desired state of SsdLoki
...
// SsdLoki is the Schema for the ssdlokis API
type SsdLoki struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   SsdLokiSpec   `json:"spec,omitempty"`
	Status SsdLokiStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// SsdLokiList contains a list of SsdLoki
